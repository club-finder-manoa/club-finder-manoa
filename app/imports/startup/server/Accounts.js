...
function addUserToCollection({ email, displayName, aboutMe, picture, savedClubs, interests, adminForClubs }, accountID) {
  console.log(`  Defining user data for ${email}`);
  Users.collection.insert({ accountID, email, displayName, aboutMe, picture, savedClubs, interests, adminForClubs });
}
